...
| **Português (PT-PT)** | **English (EN-US)** |
|-----------------------|---------------------|
| - **Mestres da Guilda** (identidades secretas)<br>- Assassinos anónimos conhecidos apenas pelos seus contratos<br>- Rivais declarados da [Guilda dos Ladrões](guild_of_thieves.md) | - **Guild Masters** (secret identities)<br>- Anonymous assassins known only by their contracts<br>- Declared rivals of the [Thieves Guild](guild_of_thieves.md) |
