...
| **🔮 OBS** | **🔮 Notes** |
| ---------- | ------------ |
| - *Glamoured Studded Leather*: +1 AC; pode assumir aparência de roupa normal.<br>- *Headband of Intellect*: INT = 19.<br>- *Cloak of Billowing*: bónus para esvoaçar dramaticamente.<br>- *Casaco de Erdna*: lança *Light* 1/dia.<br>- *Anel Illithid*: invoca Illithids de [Zorb](zorb.md).<br>- *Anel Taberna*: conduz à [Taverna](taverna.md) mais próxima. | - *Glamoured Studded Leather*: +1 AC; can appear as normal clothing.<br>- *Headband of Intellect*: INT = 19.<br>- *Cloak of Billowing*: bonus action to billow dramatically.<br>- *Erdna’s Coat*: casts *Light* 1/day.<br>- *Illithid Ring*: summons Illithids of [Zorb](zorb.md).<br>- *Tavern Ring*: leads to nearest [Tavern](taverna.md). |
