...
| ![pc_lucien_01](pc_lucien_01.png){width=300} | ![pc_lucien_02](pc_lucien_02.png){width=200} |
| ---------------------------------------------- | ---------------------------------------------- |
...
| 🎲 Jogador | 🎲 Player |
| --------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------- |
| **Jogador:** [Eduardo Verdete](eduardo_verdete.md) | **Player:** [Eduardo Verdete](eduardo_verdete.md) |
| **Idade:** 22 | **Age:** 22 |
...
| Classe: [Paladino](https://www.dndbeyond.com/classes/paladin) (juramento próprio) / [Guerreiro](https://www.dndbeyond.com/classes/fighter) | Class: [Paladin](https://www.dndbeyond.com/classes/paladin) (custom oath) / [Fighter](https://www.dndbeyond.com/classes/fighter) |
| Alinhamento: Neutro Legal | Alignment: Lawful Neutral |
| Background: [Nobre](nobre.md) | Background: [Noble](nobre.md) |
...
| **📖 História – Antes da Taberna** | **📖 Story – Before the Tavern** |
| ---------------------------------- | -------------------------------- |
| - Nascido herdeiro da [Casa Drakonis](casa_drakonis.md) e prodígio da Ordem Sagrada.<br>- Aos 10 anos perdeu a sua ligação à Luz devido a um ritual proibido feito pela própria família.<br>- Foi desonrado, abandonado e exilado.<br>- Vagou até encontrar o [Ermitão das Sombras](ermitao_das_sombras.md), um ex-paladino que dominava luz e trevas.<br>- Sob treino severo, fortaleceu corpo e espírito, aguardando o momento de quebrar o selo que o prendia.<br>- Libertou-se e regressou mais poderoso que nunca, derrotando rivais e obrigando-os a reconhecer a sua autoridade. | - Born heir to [House Drakonis](casa_drakonis.md) and prodigy of the Sacred Order.<br>- At age 10, lost his connection to the Light due to a forbidden ritual by his own family.<br>- Disgraced, abandoned, and exiled.<br>- Wandered until he met the [Hermit of Shadows](ermitao_das_sombras.md), a former paladin who mastered both light and darkness.<br>- Under harsh training, honed body and mind, awaiting the day he would break his seal.<br>- Upon breaking free, returned stronger, defeated rivals, and forced them to acknowledge his authority. |
...
| **📖 História – Depois da Taberna** | **📖 Story – After the Tavern** |
| ----------------------------------- | -------------------------------- |
| - Procura impor uma nova ordem e redefinir a justiça pelos seus próprios termos.<br>- Continua a carregar lealdade à [Casa Drakonis](casa_drakonis.md) apesar da traição.<br>- Explora o mundo em busca de consolidar poder e reformar sistemas corruptos. | - Seeks to impose a new order and redefine justice on his own terms.<br>- Still bears loyalty to [House Drakonis](casa_drakonis.md) despite their betrayal.<br>- Travels the world consolidating power and reforming corrupt systems. |
...
| **🎭 Dramatis Persona** | **🎭 Dramatis Personae** |
| --------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------- |
| **NPCs de influência direta:** <br>- [Ermitão das Sombras](ermitao_das_sombras.md) — mestre e mentor.<br>- Anciãos da [Casa Drakonis](casa_drakonis.md) — traidores, alvo de reforma política.<br>- [Noiva perdida](noiva_perdida.md) — abandonou-o após a queda. | **Direct Influence NPCs:** <br>- [Hermit of Shadows](ermitao_das_sombras.md) — master and mentor.<br>- Elders of [House Drakonis](casa_drakonis.md) — betrayers, target of political reform.<br>- [Lost fiancée](noiva_perdida.md) — left him after his fall. |
...
| **🔮 OBS** | **🔮 Notes** |
| ---------- | ------------ |
| - Traços de personalidade: determinado, carismático, imponente.<br>- Ideais: justiça deve ser definida por quem tem poder e coragem para a aplicar.<br>- Vínculos: lealdade à [Casa Drakonis](casa_drakonis.md); respeito pelo [Ermitão das Sombras](ermitao_das_sombras.md).<br>- Defeitos: orgulho desmedido, desconfiança da nobreza, impaciência para fraqueza. | - Personality traits: determined, charismatic, imposing.<br>- Ideals: justice defined by those with the power and will to enforce it.<br>- Bonds: loyalty to [House Drakonis](casa_drakonis.md); respect for the [Hermit of Shadows](ermitao_das_sombras.md).<br>- Flaws: overbearing pride, distrust of nobility, impatience with weakness. |
...
| :--- | :--- |
| pc_lucien.md | eduardo_verdete.md, nobre.md, casa_drakonis.md, ermitao_das_sombras.md, noiva_perdida.md |

### Warnings

| Type | Where | Detail |
| :--- | :--- | :--- |
| **Session Data** | H2 Title | No session participation data found for "Lucien, o Imperador Renascido" in `Recapitulativo Temporada 01.md`. |
| **Link Validation** | Image Source | Image file `pc_lucien_01.png` not found in KB. |
| **Link Validation** | Image Source | Image file `pc_lucien_02.png` not found in KB. |

### Missing Files

| Type | Where | Detail |
| :--- | :--- | :--- |
| **PC/NPC** | Jogador/Player Table | `eduardo_verdete.md` (Linked for "Eduardo Verdete") |
| **Concept** | Character Table | `nobre.md` (Linked for "Nobre") |
| **NPC/Concept** | Story/Dramatis Persona/Notes Tables | `casa_drakonis.md` (Linked for "Casa Drakonis") |
| **NPC/Concept** | Story/Dramatis Persona/Notes Tables | `ermitao_das_sombras.md` (Linked for "Ermitão das Sombras") |
| **NPC/Concept** | Dramatis Persona Table | `noiva_perdida.md` (Linked for "Noiva perdida") |