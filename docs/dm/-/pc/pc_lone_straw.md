## Lone Straw ([S03](s03_ataque_rio_neem.md), [S04A](s04a_culto_two_fords.md), [S05B](s05b_campo_goblin_nerull.md))
...
| 🎲 Jogador | 🎲 Player |
| ---------------------------- | ---------------------------- |
| **Jogador:** [Francisco Pronto](francisco_pronto.md) | **Player:** [Francisco Pronto](francisco_pronto.md) |
...
| :--- | :--- |
| pc_lone_straw.md | francisco_pronto.md, nobre.md |

### Warnings

| Type | Where | Detail |
| :--- | :--- | :--- |
| **Link Validation** | `pc_lone_straw.png` | Image file not found in KB. |

### Missing Files

| Type | Where | Detail |
| :--- | :--- | :--- |
| **PC/NPC** | Jogador/Player Table | `francisco_pronto.md` (Linked for "Francisco Pronto") |
