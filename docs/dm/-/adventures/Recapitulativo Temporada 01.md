...
| **S03** | **O Ataque de Rio Neem** / `s03_ataque_rio_neem.md`                                                       | Missão de escolta de bens preciosos (hidromel/vinho) da Taberna para a enigmática **Blackfair Manor**. O grupo encontrou o mercador [Kaldros Veynor](docs/npc/-/Peculiar%20Manor/npc_kaldros_veynor.md) sob ataque de goblins e um lobo. | 🦑 CME |
...
| **S05A** | **As Máscaras da Morte** / `s05a_mascaras_da_morte.md`                                                    | Confronto em Mistwood com a Acólita **Morvanya** (serva de [Nerull](docs/dm/-/organizations/-/cults/cult_of_nerull.md)). O grupo obteve a carta de Morvanya, revelando os planos do CME para [Blackfair Manor](blackfair_manor.md) e a ameaça a Borogrove. | 🦑 CME |
| **S05B** | **O Campo Goblin de Nerull** / `s05b_campo_goblin_nerull.md`                                              | Resgate de viajantes sequestrados num **Acampamento Goblin** para rituais dedicados a [Nerull](docs/dm/-/organizations/-/cults/cult_of_nerull.md). O grupo recuperou um **Pergaminho de Feitiço de Alarm** e um **Manto de Tenente Cultista**. | 🦑 CME |
...
| **S07A** | **Emboscada a Caminho de Erybend** / `s07a_emboscada_erybend.md`                                          | Missão de **reconhecimento comercial** para [Erybend](docs/locations/-/regions/eribend.md) para estabelecer novas rotas, a pedido de [Kythria](docs/npc/-/Free%20City%20of%20Grehawk/npc_kythria.md). O grupo enfrentou Kobolds do culto (liderados por Torzac, que revelou lealdade a Nerzul antes de se suicidar). | 🦑 CME |
...
| **S08A** | **Intriga de Odrak em Erybend** / `s08a_intriga_odrak_erybend.md`                                         | Investigar raptos em [Erybend](docs/locations/-/regions/eribend.md), resultando numa emboscada por **cultistas encapuzados** na [Taberna Machado Quebrado](taberna_machado_quebrado_(eribend).md). Encontraram uma **lista de 7 alvos** de rapto do culto, sendo [Dolrea Vas](docs/npc/-/Eribend/npc_dolrea_vas.md) o próximo. | 🦑 CME |
...
| **S10C** | **O Baile da Rainha Caecena** / `s10c_baile_rainha_caecena.md`                                            | Participar num Baile de Gala no Feywild. Houve uma tentativa de ataque orquestrada por Lord Coriver (inimigo da Rainha Caecena), envolvendo homens-serpente. [Kai](docs/pc/-/pc_kai_vanthir.md) recebeu a **Bênção da Rainha**. | 👑 Arco Externo |
| **S11A** | **Sombras de Iuz: A Chantagem e a Captura** / `s11a_sombras_de_iuz.md`                                    | [Kai](docs/pc/-/pc_kai_vanthir.md) foi chantageado pelo Drow **Raveth Xil-Zyrl** (agente de [Iuz](iuz.md)) que ameaçou expor o seu segredo como impostor. O confronto culminou na **captura de [Dustin Thorne](pc_dustin_thorne.md)** pelos [Paladinos de Beltar](order_of_beltar.md). | 🛡️ Beltar/Queda do Paladino |
| **S11B** | **Sombras Sobre Erybend** / `s11b_sombras_sobre_erybend.md`                                               | Desmantelar a célula do Culto de Odrak num templo na periferia de [Erybend](docs/locations/-/regions/eribend.md) para libertar os raptados e proteger [Dolrea Vas](docs/npc/-/Eribend/npc_dolrea_vas.md). | 🦑 CME |
| **S12** | **O Legado de Krixis, o Valente** / `s12_legado_de_krixis.md`                                             | Ajudar o Kobold [Snikil Pescabrasa](docs/npc/-/unknown/npc_snikil_pescabrasa.md) a recuperar a **Espada de Krixis**, roubada por criaturas sinistras num templo, para quebrar a maldição sobre o clã Vermisombra. | 🦑 CME |
...
| **S14A** | **Guildas de Greyhawk** / `s14a_guildas_greyhawk.md`                                                      | Missão urgente de **reconhecimento e burocracia** em [Greyhawk](free_city_of_greyhawk.md) após o ataque Paladino. O grupo obteve licenças e mapeou o submundo (rivalidade entre [Guilda de Ladrões](docs/organizations/-/guilds/guild_of_thieves.md) e [Assassinos](assassins_guild.md)). | 🦑 CME |
| **S14B** | **Dandan e os 40 Kobolds** / `s14b_dandan_e_os_40_kobolds.md`                                             | Investigar Kobolds em **Bernagrade** que roubaram a Espada de Viltrix. [Gauthak](pc_gauthak_vunakamune.md) confrontou e matou o líder alado **[Dandan](docs/npc/-/Free%20City%20of%20Grehawk/npc_dandan.md)**. O grupo descobriu um **mapa de renovação** para a ocupação Kobold. | 🦑 CME |
...
| **S17B** | **A Criança Perdida e o Espectro** / `s17b_a_crianca_perdida.md`                                          | Resgate urgente de **[Aria Greenbottle](docs/npc/-/Free%20City%20of%20Grehawk/npc_aria_greenbottle.md)** de ruínas. Foi o primeiro contacto jogado com a entidade **"A Voz no Véu"** e a fragmentação ([Gema das Cinco Vozes](gema_das_cinco_vozes.md)), confirmando a corrupção do CME. | 🦑 CME |
...
| **S22** | **O Golpe dos Dados Rubi (Parte 1)** / `s22a_golpe_dados_rubi_p1.md`                                      | Recrutamento (via pergaminho mágico) para roubar os **Dados Rubi da Fortuna** do cassino "O Quinto Jogo". O grupo passou pelo Teste do Armazém Hexagonal e obteve a colaboração secreta de **[Lorde Aleister Devraine](docs/npc/-/Free%20City%20of%20Grehawk/npc_lord_aleister_devraine.md)**. | 🦑 CME |
...
| **S25** | **A Sociedade dos Ratos Sedentos** / `s25_sociedade_ratos_sedentos.md`                                    | Investigação de uma **sociedade de ratos inteligentes e mágicos** sob o Caldeirão do Grifo ([Lorde Aleister Devraine](docs/npc/-/Free%20City%20of%20Grehawk/npc_lord_aleister_devraine.md)) que realizava rituais de sangue liderados pelo Vidente Escarlate. | 🦑 CME |
...
| **S29A** | **O Museu das Sombras (Parte 2)** / `s29a_museu_sombras_p2.md`                                            | Desmascarar o Curador **[Darsen](docs/npc/-/unknown/npc_darsen.md)** e banir a entidade demoníaca **Raelith**. O grupo encontrou a [Ranger Eirwen](pc_eirwen.md), que procurava por aventureiros desaparecidos. | 🦑 CME |
| **S29B** | **O Ídolo de Lady Scale (Parte 1)** / `s29b_idolo_lady_scale_p1.md`                                       | Investigação da herança de [Lady Silvra Malren](docs/npc/-/Free%20City%20of%20Grehawk/npc_lady_silvra_malren.md) (o **Spa do Lago do Chão Azul**). O grupo decifrou a carta em Dracónico Arcaico, confirmando a ligação ao culto dracónico de **Lady Scale**. | 🦑 CME (Dracónico) |
...
| 🦑 Arco da Corrupção do Mal Elemental | 🦑 Elemental Evil Corruption Arc |
| :--- | :--- |
| Foco na disseminação de pragas fúngicas telepáticas, rituais em moinhos e caça a relíquias elementais. O culto tenta manipular a linha temporal e eliminar Vrith Boralis para impedir o surgimento de [Sarvian](pc_sarvian_midlor.md). [Vaelkor Ashbrand](docs/npc/-/Abandoned%20Village/npc_vaelkor_ashbrand.md) e Lorde Vaeltherin Duskbane atuam como antagonistas. Liga-se a [Peculiar Manor](peculiar_manor.md), adaptada ao culto. | Centers on telepathic fungal blights, mill-site rituals, and the hunt for elemental relics. The cult seeks to bend the timeline and kill Vrith Boralis to prevent [Sarvian](pc_sarvian_midlor.md)’s rise. [Vaelkor Ashbrand](docs/npc/-/Abandoned%20Village/npc_vaelkor_ashbrand.md) and Lord Vaeltherin Duskbane are active foes. Ties into [Peculiar Manor](peculiar_manor.md), reworked for the cult. |
...
| 👑 Arco Externo (Feywild/Caecena) | 👑 Feywild/Caecena Arc |
| :--- | :--- |
| Relações com o reino das fadas. O **Baile da Rainha Caecena** culmina no rapto pelo **Lord Coriver** e no resgate, com [Kai](docs/pc/-/pc_kai_vanthir.md) a receber a **bênção da Rainha**. [Dustin](pc_dustin_thorne.md) liga-se a [Prysanna](docs/npc/-/Fey/npc_pryssana.md) por contrato inquebrável. Um ritual com o unicórnio de [Titania](docs/npc/-/Fey/npc_titania.md) forja uma espada mágica. | Dealings with the fae realm. The **Queen Caecena’s Ball** leads to abduction by **Lord Coriver** and a rescue, with [Kai](docs/pc/-/pc_kai_vanthir.md) earning the **Queen’s blessing**. [Dustin](pc_dustin_thorne.md) is bound to [Prysanna](docs/npc/-/Fey/npc_pryssana.md) by an unbreakable pact. A ritual with [Titania](docs/npc/-/Fey/npc_titania.md)’s unicorn forges a magic blade. |
...
| 🛡️ Arco de Beltar e a Queda do Paladino | 🛡️ Beltar and the Paladin’s Fall Arc |
| :--- | :--- |
| [Dustin](pc_dustin_thorne.md) deserta dos [Paladinos de Beltar](order_of_beltar.md) por recusar matar uma família de kobolds. Capturado e torturado no **[Castelo Ruína-de-Ebano](castelo_ruina_de_ebano.md)**, é salvo pela intervenção de [Prysanna](docs/npc/-/Fey/npc_pryssana.md). O arco culmina no confronto com o **Alto Inquisidor [Malrik Dorn](docs/npc/-/Ruins%20of%20House%20Vanthir/npc_malrik_dorn.md)**. | [Dustin](pc_dustin_thorne.md) deserts [Beltar’s Paladins](order_of_beltar.md) after refusing to kill a kobold family. Captured and tortured in **[Ebon-Ruin Castle](castelo_ruina_de_ebano.md)**, he’s rescued through [Prysanna](docs/npc/-/Fey/npc_pryssana.md)’s intervention. The arc peaks in a showdown with **High Inquisitor [Malrik Dorn](docs/npc/-/Ruins%20of%20House%20Vanthir/npc_malrik_dorn.md)**. |
...
| :--- | :--- |
| Ascensão do grupo no submundo. Inclui o **Golpe dos Dados Rubi** num cassino, a queda da **Sociedade dos Ratos Sedentos** financiada por terceiros, e potenciais operações contra a [Guilda dos Ladrões](docs/organizations/-/guilds/guild_of_thieves.md)/[Assassinos](assassins_guild.md) de **Org Nenshen**. [Raveth Xil’Zyrl](docs/npc/-/unknown/npc_raveth_xil_zyrl.md) chantageia [Kai](docs/pc/-/pc_kai_vanthir.md), jogando em várias frentes. | The party’s rise in the underworld. Includes the **Ruby Dice Heist** at a casino, the takedown of the **Thirsting Rats Society** backed by outside money, and possible moves against **Org Nenshen’s** [Thieves](docs/organizations/-/guilds/guild_of_thieves.md)/[Assassins Guild](assassins_guild.md). [Raveth Xil’Zyrl](docs/npc/-/unknown/npc_raveth_xil_zyrl.md) blackmails [Kai](docs/pc/-/pc_kai_vanthir.md), playing multiple angles. |

---

### 💀 Arco da Morte e Corrupção de Nerull/Wee Jas / 💀 Nerull/Wee Jas Death and Corruption Arc

| 💀 Arco da Morte e Corrupção de [Nerull](docs/dm/-/organizations/-/cults/cult_of_nerull.md)/[Wee Jas](wee_jas.md) | 💀 [Nerull](docs/dm/-/organizations/-/cults/cult_of_nerull.md)/[Wee Jas](wee_jas.md) Death and Corruption Arc |
| :--- | :--- |
| Propagação de praga ao serviço de [Nerull](docs/dm/-/organizations/-/cults/cult_of_nerull.md) e fricção com [Wee Jas](wee_jas.md). Em **Mistwood**, a **Acólita Morvanya** transforma a aldeia num laboratório vivo. [Markus](pc_markus_grimm.md) recebe orientação de [Wee Jas](wee_jas.md) para desfazer altares de [Nerull](docs/dm/-/organizations/-/cults/cult_of_nerull.md). No Vale do Vento Sombrio, o altar de **Syzzin** exibe energia **fiend** e o símbolo de [Wee Jas](wee_jas.md), sugerindo corrupção interna. | Plague spread in [Nerull](docs/dm/-/organizations/-/cults/cult_of_nerull.md)’s name and tension with [Wee Jas](wee_jas.md). In **Mistwood**, **Acolyte Morvanya** turns the village into a living lab. [Markus](pc_markus_grimm.md) is guided by [Wee Jas](wee_jas.md) to unmake [Nerull](docs/dm/-/organizations/-/cults/cult_of_nerull.md)’s shrines. In the Vale of the Shadowed Wind, **Syzzin’s** altar shows **fiend** energy and [Wee Jas](wee_jas.md)’s sigil, hinting at internal corruption. |
...
| Sessão | Nome da Missão (PT) / Slug (PT) | Objetivo Central Reconciliado | Elementos-Chave |
| :--- | :--- | :--- | :--- |
| **S10C** | **O Baile da Rainha Caecena** / `s10c_baile_rainha_caecena.md` | Participar num **Baile de Gala** no Feywild no Castelo da **Rainha Caecena**. A missão social transformou-se numa crise após um **rapto em massa** orquestrado por **Lord Coriver**. | [Kai](docs/pc/-/pc_kai_vanthir.md) recebeu a **Bênção da Rainha**. A Paladina Fae, [Pryssana](docs/npc/-/Fey/npc_pryssana.md) (seguidora de [Titania](docs/npc/-/Fey/npc_titania.md), deusa rival de [Beltar](beltar.md)), é introduzida, estabelecendo o palco para o resgate de [Dustin](pc_dustin_thorne.md). |

**Ligação ao CME:** O sucesso deste baile e o encorajamento da Rainha Caecena levam-na a intervir em [Greyhawk](free_city_of_greyhawk.md), o que permite que [Pryssana](docs/npc/-/Fey/npc_pryssana.md) seja enviada para auxiliar no resgate de [Dustin](pc_dustin_thorne.md) (Arco de Beltar).
...
| Sessão | Nome da Missão (PT) / Slug (PT)                                        | Objetivo Central Reconciliado | Elementos-Chave |
| :------- | :--------------------------------------------------------------------- | :---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | :----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **S11A** | **Sombras de Iuz: A Chantagem e a Captura** / `s11a_sombras_de_iuz.md` | Lidar com a chantagem do Drow **[Raveth Xil-Zyrl](docs/npc/-/unknown/npc_raveth_xil_zyrl.md)** (agente de [Iuz](iuz.md)) a [Kai](docs/pc/-/pc_kai_vanthir.md). O confronto culmina na **captura de [Dustin Thorne](pc_dustin_thorne.md)** pelos [Paladinos de Beltar](order_of_beltar.md), que o levam para o **[Castelo Ruína-de-Ebano](castelo_ruina_de_ebano.md)**. | [Raveth](docs/npc/-/unknown/npc_raveth_xil_zyrl.md) queria usar [Kai](docs/pc/-/pc_kai_vanthir.md) para influenciar a [Casa Vanthir](house_vanthir.md) em nome de [Iuz](iuz.md). O foco muda de [Kai](docs/pc/-/pc_kai_vanthir.md) para o resgate de [Dustin](pc_dustin_thorne.md). |
| **S13A** | **Sombras de Iuz: O Resgate de Dustin** / `s13a_resgate_dustin.md`     | Infiltrar o **[Castelo Ruína-de-Ebano](castelo_ruina_de_ebano.md)** e resgatar [Dustin](pc_dustin_thorne.md) da tortura do Inquisidor **[Malik Dorne](docs/npc/-/Ruins%20of%20House%20Vanthir/npc_malrik_dorn.md)**. | [Malik Dorne](docs/npc/-/Ruins%20of%20House%20Vanthir/npc_malrik_dorn.md) **roubou a memória** de [Dustin](pc_dustin_thorne.md) sobre a localização da Taberna. O ataque forçou o Taberneiro a mudar o *hub* de segurança. A Paladina Fae [Pryssana](docs/npc/-/Fey/npc_pryssana.md) fornece informações internas contra [Beltar](beltar.md). |
...
**Interligação:** Este arco mostra como as forças do CME usam **fanáticos religiosos** (como [Malik Dorne](docs/npc/-/Ruins%20of%20House%20Vanthir/npc_malrik_dorn.md)) e **agentes externos** (como [Raveth](docs/npc/-/unknown/npc_raveth_xil_zyrl.md), servo de [Iuz](iuz.md)) para desestabilizar as potências de Lei.
...
| Sessão | Nome da Missão (PT) / Slug (PT) | Objetivo Central Reconciliado | Elementos-Chave |
| :--- | :--- | :--- | :--- |
| **S04B/S05A** | **Fungos Telepáticos e Morvanya** / `s04b_vale_sombrio_culto_alado.md` | O fungo alienígena é descoberto como sendo **telepático**, indicando que o CME não é apenas elemental, mas também utiliza tecnologia/vida alienígena. | A silhueta que [Vaunia](pc_vaunia_kolakiala.md) vê no Rubi é **Morvanya** (Manvea), a Acólita de [Nerull](docs/dm/-/organizations/-/cults/cult_of_nerull.md). |
| **S08B/S13B** | **A Abdução Alienígena e o Crash** / `s08_templo_basilisco_pedras.md` & `s13b_retorno_nave_illithid.md` | **Três Pedras Mágicas** Illithid são reunidas, ativando um farol de emergência que leva à **abdução** de [Thoren](npc_thoren.md) por um *starship*. A [nave](nave_illithid.md) mais tarde **despenha-se em [Greyhawk](free_city_of_greyhawk.md)**. | A morte de Varus e a sua ressurreição como **[Zeldris](pc_zeldris.md)**, ligado à tecnologia Illithid, cimenta a interferência alienígena. |
| **S17B** | **A Criança Perdida e o Espectro** / `s17b_a_crianca_perdida.md` | Resgate de **[Aria Greenbottle](docs/npc/-/Free%20City%20of%20Grehawk/npc_aria_greenbottle.md)** das ruínas. É o **primeiro contacto jogado** com a entidade **"A Voz no Véu"**, que se comunica através de [Aria](docs/npc/-/Free%20City%20of%20Grehawk/npc_aria_greenbottle.md). | O grupo recupera a **[Gema das Cinco Vozes](gema_das_cinco_vozes.md)** (Fragmento Sombrio), confirmando o tema da **Fragmentação**. A Voz no Véu é descrita como bela, mas a chorar. |
...
| **[Kai](docs/pc/-/pc_kai_vanthir.md)**                                  | 13/02/2025             | 1 de Sunsebb, 998 CY (Semana 07)     | S07A        | `s07a_emboscada_erybend.md`        |
| **[Kai](docs/pc/-/pc_kai_vanthir.md)**                                  | 20/02/2025             | 8 de Sunsebb, 998 CY (Semana 08)     | S08A        | `s08a_intriga_odrak_erybend.md`    |
| **[Kai](docs/pc/-/pc_kai_vanthir.md)**                                  | 06/03/2025             | 22 de Sunsebb, 998 CY (Semana 10)    | S10C        | `s10c_baile_rainha_caecena.md`     |
| **[Kai](docs/pc/-/pc_kai_vanthir.md)**                                  | 13/03/2025             | 1 de Needfest, 999 CY (Semana 11)    | S11A        | `s11a_sombras_de_iuz.md`           |
| **[Kai](docs/pc/-/pc_kai_vanthir.md)**                                  | 13/03/2025             | 1 de Needfest, 999 CY (Semana 11)    | S11B        | `s11b_sombras_sobre_erybend.md`    |
| **[Kai](docs/pc/-/pc_kai_vanthir.md)**                                  | 20/03/2025             | 1 de Fireseek, 999 CY (Semana 12)    | S12         | `s12_legado_de_krixis.md`          |
| **[Kai](docs/pc/-/pc_kai_vanthir.md)**                                  | 27/03/2025             | 8 de Fireseek, 999 CY (Semana 13)    | S13A        | `s13a_resgate_dustin.md`           |
| **[Kai](docs/pc/-/pc_kai_vanthir.md)**                                  | 24/04/2025             | 8 de Readying, 999 CY (Semana 17)    | S17A        | `s17a_missao_assassinos.md`        |
...
|**🦑 Arco da Corrupção do Mal Elemental**|**🦑 Elemental Evil Corruption Arc**|
|:--|:--|
|Foco na disseminação de pragas fúngicas telepáticas, rituais em moinhos e caça a relíquias elementais. O culto tenta manipular a linha temporal e eliminar Vrith Boralis para impedir o surgimento de Sarvian. Vaelkor Ashbrand e Lorde Vaeltherin Duskbane atuam como antagonistas. Liga-se a Peculiar Manor, adaptada ao culto.|Centers on telepathic fungal blights, mill-site rituals, and the hunt for elemental relics. The cult seeks to bend the timeline and kill Vrith Boralis to prevent Sarvian’s rise. Vaelkor Ashbrand and Lord Vaeltherin Duskbane are active foes. Ties into Peculiar Manor, reworked for the cult.|

---

|**👽 Arco da Conexão Cósmica**|**👽 Cosmic Connection Arc**|
|:--|:--|
|Mistérios que transcendem Greyhawk e mexem com mente e realidade. Inclui o Museu das Maravilhas com entidades extradimensionais e o curador semi-possuído por **Yzr’alith**. Aparece um **Spectator** no confronto com Malrik Dorn, e em _O Eclipse de Vauria_ o grupo recupera um **Prisma Celestial** e enfrenta **Nyx’Zul, O Olho na Escuridão**.|Mysteries beyond Greyhawk that warp mind and reality. Includes the Museum of Wonders with extradimensional beings and a curator half-claimed by **Yzr’alith**. A **Spectator** shows up in the Malrik Dorn fight, and in _The Eclipse of Vauria_ the party recovers a **Celestial Prism** and faces **Nyx’Zul, the Eye in the Dark**.|

---

|**👑 Arco Externo (Feywild/Caecena)**|**👑 Feywild/Caecena Arc**|
|:--|:--|
|Relações com o reino das fadas. O **Baile da Rainha Caecena** culmina no rapto pelo **Lorde Coriver** e no resgate, com **Kai** a receber a **bênção da Rainha**. **Dustin** liga-se a **Prysanna** por contrato inquebrável. Um ritual com o unicórnio de **Titania** forja uma espada mágica.|Dealings with the fae realm. The **Queen Caecena’s Ball** leads to abduction by **Lord Coriver** and a rescue, with **Kai** earning the **Queen’s blessing**. **Dustin** is bound to **Prysanna** by an unbreakable pact. A ritual with **Titania’s** unicorn forges a magic blade.|

---

|**🛡️ Arco de Beltar e a Queda do Paladino**|**🛡️ Beltar and the Paladin’s Fall Arc**|
|:--|:--|
|**Dustin** deserta dos Paladinos de Beltar por recusar matar uma família de kobolds. Capturado e torturado no **Castelo Ruína-de-Ebano**, é salvo pela intervenção de **Prysanna**. O arco culmina no confronto com o **Alto Inquisidor Malrik Dorn**.|**Dustin** deserts Beltar’s Paladins after refusing to kill a kobold family. Captured and tortured in **Ebon-Ruin Castle**, he’s rescued through **Prysanna’s** intervention. The arc peaks in a showdown with **High Inquisitor Malrik Dorn**.|

---

|**🔪 Arco da Intriga e Submundo de Greyhawk**|**🔪 Greyhawk Intrigue and Underworld Arc**|
|:--|:--|
|Ascensão do grupo no submundo. Inclui o **Golpe dos Dados Rubi** num cassino, a queda da **Sociedade dos Ratos Sedentos** financiada por terceiros, e potenciais operações contra a **Guilda dos Ladrões/Assassinos** de **Org Nenshen**. **Raveth Xil’Zyrl** chantageia **Kai**, jogando em várias frentes.|The party’s rise in the underworld. Includes the **Ruby Dice Heist** at a casino, the takedown of the **Thirsting Rats Society** backed by outside money, and possible moves against **Org Nenshen’s** Thieves/Assassins Guild. **Raveth Xil’Zyrl** blackmails **Kai**, playing multiple angles.|

---

|**💀 Arco da Morte e Corrupção de Nerull/Wee Jas**|**💀 Nerull/Wee Jas Death and Corruption Arc**|
|:--|:--|
|Propagação de praga ao serviço de **Nerull** e fricção com **Wee Jas**. Em **Mistwood**, a **Acólita Morvanya** transforma a aldeia num laboratório vivo. **Markus** recebe orientação de **Wee Jas** para desfazer altares de Nerull. No Vale do Vento Sombrio, o altar de **Syzzin** exibe energia **fiend** e o símbolo de **Wee Jas**, sugerindo corrupção interna.|Plague spread in **Nerull’s** name and tension with **Wee Jas**. In **Mistwood**, **Acolyte Morvanya** turns the village into a living lab. **Markus** is guided by **Wee Jas** to unmake Nerull’s shrines. In the Vale of the Shadowed Wind, **Syzzin’s** altar shows **fiend** energy and **Wee Jas’s** sigil, hinting at internal corruption.|
...
| Sessão | Nome da Missão (PT) / Slug (PT) | Objetivo Central Reconciliado | Elementos-Chave |
| :--- | :--- | :--- | :--- |
| **S10C** | **O Baile da Rainha Caecena** / `s10c_baile_rainha_caecena.md` | Participar num **Baile de Gala** no Feywild no Castelo da **Rainha Caecena**. A missão social transformou-se numa crise após um **rapto em massa** orquestrado por **Lord Coriver**. | **Kai** recebeu a **Bênção da Rainha**. A Paladina Fae, **Pryssana** (seguidora de Titania, deusa rival de Beltar), é introduzida, estabelecendo o palco para o resgate de Dustin. |

**Ligação ao CME:** O sucesso deste baile e o encorajamento da Rainha Caecena levam-na a intervir em Greyhawk, o que permite que Pryssana seja enviada para auxiliar no resgate de Dustin (Arco de Beltar).

***

## 🛡️ Arco de Beltar e a Queda do Paladino (S11A, S13A, S15A)

Este arco foca-se no passado de **Dustin Thorne** e na sua Ordem (os **Paladinos de Beltar**), que, apesar de caçarem ameaças como o Culto, se tornam um perigo para o próprio Dustin devido a fanáticos.

| Sessão | Nome da Missão (PT) / Slug (PT) | Objetivo Central Reconciliado | Elementos-Chave |
| :--- | :--- | :--- | :--- |
| **S11A** | **Sombras de Iuz: A Chantagem e a Captura** / `s11a_sombras_de_iuz.md` | Lidar com a chantagem do Drow **Raveth Xil-Zyrl** (agente de Iuz) a **Kai**. O confronto culmina na **captura de Dustin Thorne** pelos Paladinos de Beltar, que o levam para o **Castelo Ruína-de-Ebano**. | Raveth queria usar Kai para influenciar a Casa Vanthir em nome de **Iuz**. O foco muda de Kai para o resgate de Dustin. |
| **S13A** | **Sombras de Iuz: O Resgate de Dustin** / `s13a_resgate_dustin.md` | Infiltrar o **Castelo Ruína-de-Ebano** e resgatar Dustin da tortura do Inquisidor **Malik Dorne**. | Malik Dorne **roubou a memória** de Dustin sobre a localização da Taberna. O ataque forçou o Taberneiro a mudar o *hub* de segurança. A Paladina Fae **Pryssana** fornece informações internas contra Beltar. |
| **S15A** | **O Ceptro de Zan e o Culto da Mão** / `s15a_ceptro_de_zan.md` | Recuperar o **Ceptro amaldiçoado de Zan** do local do *crash* Illithid. **Dustin é amaldiçoado** pela voz de Zan, que tenta redirecionar a sua fúria para **Kas**, um antigo traidor. | A maldição é um *plot hook* que liga a fúria de Dustin ao conflito de Zan. O roubo da **Mão de Zan** pelo CME liga este deus-guerreiro ao arco da Corrupção. |

**Interligação:** Este arco mostra como as forças do CME usam **fanáticos religiosos** (como Malik Dorne) e **agentes externos** (como Raveth, servo de Iuz) para desestabilizar as potências de Lei.
...
| Sessão | Nome da Missão (PT) / Slug (PT) | Objetivo Central Reconciliado | Elementos-Chave |
| :--- | :--- | :--- | :--- |
| **S04B/S05A** | **Fungos Telepáticos e Morvanya** / `s04b_vale_sombrio_culto_alado.md` | O fungo alienígena é descoberto como sendo **telepático**, indicando que o CME não é apenas elemental, mas também utiliza tecnologia/vida alienígena. | A silhueta que Vaunia vê no Rubi é **Morvanya** (Manvea), a Acólita de Nerull. |
| **S08B/S13B** | **A Abdução Alienígena e o Crash** / `s08_templo_basilisco_pedras.md` & `s13b_retorno_nave_illithid.md` | **Três Pedras Mágicas** Illithid são reunidas, ativando um farol de emergência que leva à **abdução** de Thoren por um *starship*. A nave mais tarde **despenha-se em Greyhawk**. | A morte de Varus e a sua ressurreição como **Zeldris**, ligado à tecnologia Illithid, cimenta a interferência alienígena. |
| **S17B** | **A Criança Perdida e o Espectro** / `s17b_a_crianca_perdida.md` | Resgate de **Aria Greenbottle** das ruínas. É o **primeiro contacto jogado** com a entidade **"A Voz no Véu"**, que se comunica através de Aria. | O grupo recupera a **Gema das Cinco Vozes** (Fragmento Sombrio), confirmando o tema da **Fragmentação**. A Voz no Véu é descrita como bela, mas a chorar. |
| **S15B** | **Eldric e Silfir Sem Memórias** / `s15b_a_crianca_perdida.md` | Introdução dos novos PCs **Eldric Silvanos** e **Silfir**, que **acordam sem memórias** e são imediatamente recrutados para a missão. | A **amnésia** recorrente pode ser um resultado da tecnologia Illithid ou de um dos feitiços elementais. |
...
| PC Name | Date of Session (Real) | In Game Game Date | Session No. | File Name of the Session |
| :--- | :--- | :--- | :--- | :--- |
| **Arkos Vasell** | 16/01/2025 | 1 de Ready'reat, 998 CY (Semana 03) | S03 | `s03_ataque_rio_neem.md` |
| **Arkos Vasell** | 23/01/2025 | 8 de Ready'reat, 998 CY (Semana 04) | S04A | `s04a_culto_two_fords.md` |
| **Bok Thunderfist** | 13/02/2025 | 1 de Sunsebb, 998 CY (Semana 07) | S07B | `s07b_pantano_basilisco.md` |
| **Bok Thunderfist** | 20/02/2025 | 8 de Sunsebb, 998 CY (Semana 08) | S08B | `s08_templo_basilisco_pedras.md` |
| **Bok Thunderfist** | 27/03/2025 | 8 de Fireseek, 999 CY (Semana 13) | S13B | `s13b_retorno_nave_illithid.md` |
| **Bok Thunderfist** | 24/04/2025 | 8 de Readying, 999 CY (Semana 17) | S17B | `s17b_a_crianca_perdida.md` |
| **Bok Thunderfist** | 29/05/2025 | 15 de Coldeven, 999 CY (Semana 22) | S22 | `s22a_golpe_dados_rubi_p1.md` |
| **Bok Thunderfist** | 05/06/2025 | 22 de Coldeven, 999 CY (Semana 23) | S23 | `s23a_golpe_dados_rubi_p2.md` |
| **Bok Thunderfist** | 17/07/2025 | 11 de Growfest, 999 CY (Semana 29) | S29B | `s29b_idolo_lady_scale_p1.md` |
| **Bok Thunderfist** | 24/07/2025 | 18 de Growfest, 999 CY (Semana 30) | S30B | `s30b_idolo_lady_scale_p2.md` |
| **Bok Thunderfist** | 31/07/2025 | 25 de Growfest, 999 CY (Semana 31) | S31 | `s31_idolo_lady_scale_p3.md` |
| **Conan o Bárbaro** | 02/01/2025 | 15 de Patchwall, 998 CY (Semana 01) | S01 | `s01_purificacao_riacho.md` |
| **Conan o Bárbaro** | 09/01/2025 | 22 de Patchwall, 998 CY (Semana 02) | S02 | `s02_miner_difficulties_ready.md` |
| **Conan o Bárbaro** | 23/01/2025 | 8 de Ready'reat, 998 CY (Semana 04) | S04B | `s04b_vale_sombrio_culto_alado.md` |
| **Conan o Bárbaro** | 13/02/2025 | 1 de Sunsebb, 998 CY (Semana 07) | S07B | `s07b_pantano_basilisco.md` |
| **Conan o Bárbaro** | 20/02/2025 | 8 de Sunsebb, 998 CY (Semana 08) | S08B | `s08_templo_basilisco_pedras.md` |
| **Conan o Bárbaro** | 06/03/2025 | 22 de Sunsebb, 998 CY (Semana 10) | S10B | `s10b_resgate_rolger.md` |
| **Conan o Bárbaro** | 03/04/2025 | 15 de Fireseek, 999 CY (Semana 14) | S14 | `s14a_guildas_greyhawk.md` |
| **Conan o Bárbaro** | 24/04/2025 | 8 de Readying, 999 CY (Semana 17) | S17A | `s17a_missao_assassinos.md` |
| **Conan o Bárbaro** | 29/05/2025 | 15 de Coldeven, 999 CY (Semana 22) | S22 | `s22a_golpe_dados_rubi_p1.md` |
| **Conan o Bárbaro** | 05/06/2025 | 22 de Coldeven, 999 CY (Semana 23) | S23 | `s23a_golpe_dados_rubi_p2.md` |
| **Drayl Bharash** | 30/01/2025 | 15 de Ready'reat, 998 CY (Semana 05) | S05B | `s05b_campo_goblin_nerull.md` |
| **Drayl Bharash** | 27/02/2025 | 15 de Sunsebb, 998 CY (Semana 09) | S09A | `s09a_sombras_sobre_a_agua.md` |
| **Drayl Bharash** | 06/03/2025 | 22 de Sunsebb, 998 CY (Semana 10) | S10C | `s10c_baile_rainha_caecena.md` |
| **Drayl Bharash** | 24/04/2025 | 8 de Readying, 999 CY (Semana 17) | S17A | `s17a_missao_assassinos.md` |
| **Drayl Bharash** | 24/04/2025 | 8 de Readying, 999 CY (Semana 17) | S17B | `s17b_a_crianca_perdida.md` |
| **Dustin Thorne** | 02/01/2025 | 15 de Patchwall, 998 CY (Semana 01) | S01 | `s01_purificacao_riacho.md` |
| **Dustin Thorne** | 09/01/2025 | 22 de Patchwall, 998 CY (Semana 02) | S02 | `s02_miner_difficulties_ready.md` |
| **Dustin Thorne** | 23/01/2025 | 8 de Ready'reat, 998 CY (Semana 04) | S04B | `s04b_vale_sombrio_culto_alado.md` |
| **Dustin Thorne** | 06/03/2025 | 22 de Sunsebb, 998 CY (Semana 10) | S10C | `s10c_baile_rainha_caecena.md` |
| **Dustin Thorne** | 13/03/2025 | 1 de Needfest, 999 CY (Semana 11) | S11A | `s11a_sombras_de_iuz.md` |
| **Dustin Thorne** | 20/03/2025 | 1 de Fireseek, 999 CY (Semana 12) | S12 | `s12_legado_de_krixis.md` |
| **Dustin Thorne** | 27/03/2025 | 8 de Fireseek, 999 CY (Semana 13) | S13A | `s13a_resgate_dustin.md` |
| **Dustin Thorne** | 10/04/2025 | 22 de Fireseek, 999 CY (Semana 15) | S15A | `s15a_ceptro_de_zan.md` |
| **Eldric Silvanos** | 10/04/2025 | 22 de Fireseek, 999 CY (Semana 15) | S15B | `s15b_a_crianca_perdida.md` |
| **Eldric Silvanos** | 17/07/2025 | 11 de Growfest, 999 CY (Semana 29) | S29B | `s29b_idolo_lady_scale_p1.md` |
| **Eldric Silvanos** | 24/07/2025 | 18 de Growfest, 999 CY (Semana 30) | S30B | `s30b_idolo_lady_scale_p2.md` |
| **Eldric Silvanos** | 31/07/2025 | 25 de Growfest, 999 CY (Semana 31) | S31 | `s31_idolo_lady_scale_p3.md` |
| **Eirwen** | 17/07/2025 | 11 de Growfest, 999 CY (Semana 29) | S29A | `s29a_museu_sombras_p2.md` |
| **Endouvan Bom Sossego** | 16/01/2025 | 1 de Ready'reat, 998 CY (Semana 03) | S03 | `s03_ataque_rio_neem.md` |
| **Endouvan Bom Sossego** | 23/01/2025 | 8 de Ready'reat, 998 CY (Semana 04) | S04A | `s04a_culto_two_fords.md` |
| **Endouvan Bom Sossego** | 27/03/2025 | 8 de Fireseek, 999 CY (Semana 13) | S13B | `s13b_retorno_nave_illithid.md` |
| **Flynn** | 13/02/2025 | 1 de Sunsebb, 998 CY (Semana 07) | S07B | `s07b_pantano_basilisco.md` |
| **Flynn** | 20/02/2025 | 8 de Sunsebb, 998 CY (Semana 08) | S08A | `s08a_intriga_odrak_erybend.md` |
| **Flynn** | 06/03/2025 | 22 de Sunsebb, 998 CY (Semana 10) | S10B | `s10b_resgate_rolger.md` |
| **Flynn** | 13/03/2025 | 1 de Needfest, 999 CY (Semana 11) | S11B | `s11b_sombras_sobre_erybend.md` |
| **Frederick Junsi** | 06/03/2025 | 22 de Sunsebb, 998 CY (Semana 10) | S10A | `s06a_intriga_high_ery.md` |
| **Frederick Junsi** | 03/04/2025 | 15 de Fireseek, 999 CY (Semana 14) | S14B | `s14b_dandan_e_os_40_kobolds.md` |
| **Frederick Junsi** | 10/04/2025 | 22 de Fireseek, 999 CY (Semana 15) | S15B | `s15b_a_crianca_perdida.md` |
| **Gauthak Vunakamune** | 16/01/2025 | 1 de Ready'reat, 998 CY (Semana 03) | S03 | `s03_ataque_rio_neem.md` |
| **Gauthak Vunakamune** | 23/01/2025 | 8 de Ready'reat, 998 CY (Semana 04) | S04A | `s04a_culto_two_fords.md` |
| **Gauthak Vunakamune** | 27/02/2025 | 15 de Sunsebb, 998 CY (Semana 09) | S09A | `s09a_sombras_sobre_a_agua.md` |
| **Gauthak Vunakamune** | 06/03/2025 | 22 de Sunsebb, 998 CY (Semana 10) | S10A | `s06a_intriga_high_ery.md` |
| **Gauthak Vunakamune** | 03/04/2025 | 15 de Fireseek, 999 CY (Semana 14) | S14B | `s14b_dandan_e_os_40_kobolds.md` |
| **Gauthak Vunakamune** | 10/04/2025 | 22 de Fireseek, 999 CY (Semana 15) | S15B | `s15b_a_crianca_perdida.md` |
| **Grix Molah** | 02/01/2025 | 15 de Patchwall, 998 CY (Semana 01) | S01 | `s01_purificacao_riacho.md` |
| **Grix Molah** | 09/01/2025 | 22 de Patchwall, 998 CY (Semana 02) | S02 | `s02_miner_difficulties_ready.md` |
| **Grix Molah** | 23/01/2025 | 8 de Ready'reat, 998 CY (Semana 04) | S04B | `s04b_vale_sombrio_culto_alado.md` |
| **Grix Molah** | 13/02/2025 | 1 de Sunsebb, 998 CY (Semana 07) | S07A | `s07a_emboscada_erybend.md` |
| **Grix Molah** | 20/02/2025 | 8 de Sunsebb, 998 CY (Semana 08) | S08A | `s08a_intriga_odrak_erybend.md` |
| **Grix Molah** | 06/03/2025 | 22 de Sunsebb, 998 CY (Semana 10) | S10A | `s06a_intriga_high_ery.md` |
| **Grix Molah** | 13/03/2025 | 1 de Needfest, 999 CY (Semana 11) | S11B | `s11b_sombras_sobre_erybend.md` |
| **Kai** | 13/02/2025 | 1 de Sunsebb, 998 CY (Semana 07) | S07A | `s07a_emboscada_erybend.md` |
| **Kai** | 20/02/2025 | 8 de Sunsebb, 998 CY (Semana 08) | S08A | `s08a_intriga_odrak_erybend.md` |
| **Kai** | 06/03/2025 | 22 de Sunsebb, 998 CY (Semana 10) | S10C | `s10c_baile_rainha_caecena.md` |
| **Kai** | 13/03/2025 | 1 de Needfest, 999 CY (Semana 11) | S11A | `s11a_sombras_de_iuz.md` |
| **Kai** | 13/03/2025 | 1 de Needfest, 999 CY (Semana 11) | S11B | `s11b_sombras_sobre_erybend.md` |
| **Kai** | 20/03/2025 | 1 de Fireseek, 999 CY (Semana 12) | S12 | `s12_legado_de_krixis.md` |
| **Kai** | 27/03/2025 | 8 de Fireseek, 999 CY (Semana 13) | S13A | `s13a_resgate_dustin.md` |
| **Kai** | 24/04/2025 | 8 de Readying, 999 CY (Semana 17) | S17A | `s17a_missao_assassinos.md` |
| **Ketrich Flavifer** | 17/07/2025 | 11 de Growfest, 999 CY (Semana 29) | S29A | `s29a_museu_sombras_p2.md` |
| **Ketrich Flavifer** | 24/07/2025 | 18 de Growfest, 999 CY (Semana 30) | S30A | `s30a_polimorfismo_sea_hag.md` |
| **Leo** | 10/07/2025 | 4 de Growfest, 999 CY (Semana 28) | S28A | `s28a_museu_sombras_p1.md` |
| **Leo** | 17/07/2025 | 11 de Growfest, 999 CY (Semana 29) | S29A | `s29a_museu_sombras_p2.md` |
| **Lone Straw** | 16/01/2025 | 1 de Ready'reat, 998 CY (Semana 03) | S03 | `s03_ataque_rio_neem.md` |
| **Lone Straw** | 23/01/2025 | 8 de Ready'reat, 998 CY (Semana 04) | S04A | `s04a_culto_two_fords.md` |
| **Lone Straw** | 30/01/2025 | 15 de Ready'reat, 998 CY (Semana 05) | S05B | `s05b_campo_goblin_nerull.md` |
| **Markus Grimm** | 02/01/2025 | 15 de Patchwall, 998 CY (Semana 01) | S01 | `s01_purificacao_riacho.md` |
| **Markus Grimm** | 09/01/2025 | 22 de Patchwall, 998 CY (Semana 02) | S02 | `s02_miner_difficulties_ready.md` |
| **Markus Grimm** | 23/01/2025 | 8 de Ready'reat, 998 CY (Semana 04) | S04B | `s04b_vale_sombrio_culto_alado.md` |
| **Markus Grimm** | 30/01/2025 | 15 de Ready'reat, 998 CY (Semana 05) | S05A | `s05a_mascaras_da_morte.md` |
| **Markus Grimm** | 13/03/2025 | 1 de Needfest, 999 CY (Semana 11) | S11A | `s11a_sombras_de_iuz.md` |
| **Markus Grimm** | 27/03/2025 | 8 de Fireseek, 999 CY (Semana 13) | S13A | `s13a_resgate_dustin.md` |
| **Markus Grimm** | 24/04/2025 | 8 de Readying, 999 CY (Semana 17) | S17A | `s17a_missao_assassinos.md` |
| **Markus Grimm** | 24/04/2025 | 8 de Readying, 999 CY (Semana 17) | S17B | `s17b_a_crianca_perdida.md` |
| **Markus Grimm** | 29/05/2025 | 15 de Coldeven, 999 CY (Semana 22) | S22 | `s22a_golpe_dados_rubi_p1.md` |
| **Markus Grimm** | 05/06/2025 | 22 de Coldeven, 999 CY (Semana 23) | S23 | `s23a_golpe_dados_rubi_p2.md` |
| **Orianna** | 16/01/2025 | 1 de Ready'reat, 998 CY (Semana 03) | S03 | `s03_ataque_rio_neem.md` |
| **Orianna** | 23/01/2025 | 8 de Ready'reat, 998 CY (Semana 04) | S04A | `s04a_culto_two_fords.md` |
| **Raylahn** | 06/03/2025 | 22 de Sunsebb, 998 CY (Semana 10) | S10B | `s10b_resgate_rolger.md` |
| **Raylahn** | 13/03/2025 | 1 de Needfest, 999 CY (Semana 11) | S11A | `s11a_sombras_de_iuz.md` |
| **Raylahn** | 20/03/2025 | 1 de Fireseek, 999 CY (Semana 12) | S12 | `s12_legado_de_krixis.md` |
| **Raylahn** | 27/03/2025 | 8 de Fireseek, 999 CY (Semana 13) | S13A | `s13a_resgate_dustin.md` |
| **Raylahn** | 24/04/2025 | 8 de Readying, 999 CY (Semana 17) | S17A | `s17a_missao_assassinos.md` |
| **Raylahn** | 24/04/2025 | 8 de Readying, 999 CY (Semana 17) | S17B | `s17b_a_crianca_perdida.md` |
| **Sarvian Midlor** | 30/01/2025 | 15 de Ready'reat, 998 CY (Semana 05) | S05B | `s05b_campo_goblin_nerull.md` |
| **Sarvian Midlor** | 27/02/2025 | 15 de Sunsebb, 998 CY (Semana 09) | S09B | `s09b_ondas_lo_reltarma.md` |
| **Sarvian Midlor** | 27/03/2025 | 8 de Fireseek, 999 CY (Semana 13) | S13B | `s13b_retorno_nave_illithid.md` |
| **Silfir** | 10/04/2025 | 22 de Fireseek, 999 CY (Semana 15) | S15B | `s15b_a_crianca_perdida.md` |
| **Silfir** | 17/07/2025 | 11 de Growfest, 999 CY (Semana 29) | S29B | `s29b_idolo_lady_scale_p1.md` |
| **Silfir** | 24/07/2025 | 18 de Growfest, 999 CY (Semana 30) | S30B | `s30b_idolo_lady_scale_p2.md` |
| **Silfir** | 31/07/2025 | 25 de Growfest, 999 CY (Semana 31) | S31 | `s31_idolo_lady_scale_p3.md` |
| **Triss Merril** | 02/01/2025 | 15 de Patchwall, 998 CY (Semana 01) | S01 | `s01_purificacao_riacho.md` |
| **Triss Merril** | 09/01/2025 | 22 de Patchwall, 998 CY (Semana 02) | S02 | `s02_miner_difficulties_ready.md` |
| **Triss Merril** | 23/01/2025 | 8 de Ready'reat, 998 CY (Semana 04) | S04B | `s04b_vale_sombrio_culto_alado.md` |
| **Triss Merril** | 13/02/2025 | 1 de Sunsebb, 998 CY (Semana 07) | S07A | `s07a_emboscada_erybend.md` |
| **Triss Merril** | 20/02/2025 | 8 de Sunsebb, 998 CY (Semana 08) | S08A | `s08a_intriga_odrak_erybend.md` |
| **Triss Merril** | 06/03/2025 | 22 de Sunsebb, 998 CY (Semana 10) | S10C | `s10c_baile_rainha_caecena.md` |
| **Triss Merril** | 13/03/2025 | 1 de Needfest, 999 CY (Semana 11) | S11A | `s11a_sombras_de_iuz.md` |
| **Triss Merril** | 13/03/2025 | 1 de Needfest, 999 CY (Semana 11) | S11B | `s11b_sombras_sobre_erybend.md` |
| **Triss Merril** | 20/03/2025 | 1 de Fireseek, 999 CY (Semana 12) | S12 | `s12_legado_de_krixis.md` |
| **Triss Merril** | 27/03/2025 | 8 de Fireseek, 999 CY (Semana 13) | S13A | `s13a_resgate_dustin.md` |
| **Triss Merril** | 10/04/2025 | 22 de Fireseek, 999 CY (Semana 15) | S15A | `s15a_ceptro_de_zan.md` |
| **Ulma** | 10/07/2025 | 4 de Growfest, 999 CY (Semana 28) | S28A | `s28a_museu_sombras_p1.md` |
| **Ulma** | 17/07/2025 | 11 de Growfest, 999 CY (Semana 29) | S29A | `s29a_museu_sombras_p2.md` |
| **Usopp** | 30/01/2025 | 15 de Ready'reat, 998 CY (Semana 05) | S05B | `s05b_campo_goblin_nerull.md` |
| **Ustrax** | 06/03/2025 | 22 de Sunsebb, 998 CY (Semana 10) | S10A | `s06a_intriga_high_ery.md` |
| **Ustrax** | 29/05/2025 | 15 de Coldeven, 999 CY (Semana 22) | S22 | `s22a_golpe_dados_rubi_p1.md` |
| **Ustrax** | 05/06/2025 | 22 de Coldeven, 999 CY (Semana 23) | S23 | `s23a_golpe_dados_rubi_p2.md` |
| **Vaunia** | 02/01/2025 | 15 de Patchwall, 998 CY (Semana 01) | S01 | `s01_purificacao_riacho.md` |
| **Vaunia** | 23/01/2025 | 8 de Ready'reat, 998 CY (Semana 04) | S04B | `s04b_vale_sombrio_culto_alado.md` |
| **Vaunia** | 30/01/2025 | 15 de Ready'reat, 998 CY (Semana 05) | S05A | `s05a_mascaras_da_morte.md` |
| **Vaunia** | 20/02/2025 | 8 de Sunsebb, 998 CY (Semana 08) | S08B | `s08_templo_basilisco_pedras.md` |
| **Vaunia** | 06/03/2025 | 22 de Sunsebb, 998 CY (Semana 10) | S10A | `s06a_intriga_high_ery.md` |
| **Valto** | 29/05/2025 | 15 de Coldeven, 999 CY (Semana 22) | S22 | `s22a_golpe_dados_rubi_p1.md` |
| **Valto** | 05/06/2025 | 22 de Coldeven, 999 CY (Semana 23) | S23 | `s23a_golpe_dados_rubi_p2.md` |
| **Varus/Zeldris** | 13/02/2025 | 1 de Sunsebb, 998 CY (Semana 07) | S07A | `s07a_emboscada_erybend.md` |
| **Varus/Zeldris** | 20/02/2025 | 8 de Sunsebb, 998 CY (Semana 08) | S08A | `s08a_intriga_odrak_erybend.md` |
| **Varus/Zeldris** | 06/03/2025 | 22 de Sunsebb, 998 CY (Semana 10) | S10B | `s10b_resgate_rolger.md` |
| **Varus/Zeldris** | 13/03/2025 | 1 de Needfest, 999 CY (Semana 11) | S11B | `s11b_sombras_sobre_erybend.md` |
| **Varus/Zeldris** | 27/03/2025 | 8 de Fireseek, 999 CY (Semana 13) | S13B | `s13b_retorno_nave_illithid.md` |
| **Wagner** | 24/04/2025 | 8 de Readying, 999 CY (Semana 17) | S17B | `s17b_a_crianca_perdida.md` |
| **Wandering Sage** | 23/01/2025 | 8 de Ready'reat, 998 CY (Semana 04) | S04A | `s04a_culto_two_fords.md` |
| **Wandering Sage** | 30/01/2025 | 15 de Ready'reat, 998 CY (Semana 05) | S05B | `s05b_campo_goblin_nerull.md` |
| **Wandering Sage** | 06/03/2025 | 22 de Sunsebb, 998 CY (Semana 10) | S10B | `s10b_resgate_rolger.md` |
| **Wandering Sage** | 10/04/2025 | 22 de Fireseek, 999 CY (Semana 15) | S15B | `s15b_a_crianca_perdida.md` |
| **Wandering Sage** | 29/05/2025 | 15 de Coldeven, 999 CY (Semana 22) | S22 | `s22a_golpe_dados_rubi_p1.md` |
| **Wandering Sage** | 05/06/2025 | 22 de Coldeven, 999 CY (Semana 23) | S23 | `s23a_golpe_dados_rubi_p2.md` |
| **Wandering Sage** | 24/07/2025 | 18 de Growfest, 999 CY (Semana 30) | S30B | `s30b_idolo_lady_scale_p2.md` |
| **Zahel** | 10/07/2025 | 4 de Growfest, 999 CY (Semana 28) | S28A | `s28a_museu_sombras_p1.md` |
| **Zahel** | 17/07/2025 | 11 de Growfest, 999 CY (Semana 29) | S29A | `s29a_museu_sombras_p2.md` |