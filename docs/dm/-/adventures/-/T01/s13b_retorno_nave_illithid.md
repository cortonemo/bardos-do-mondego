...
* **Endouvan:** A sua abdução há anos explica os seus "buracos de memória" e o seu conhecimento arcano de *Wilderness*.
* **Varus/Zeldris:** A ressurreição por tecnologia Illithid ligada à Pedra Mágica (Artefato) é a fonte do seu novo *alter ego*. **[Zeldris](zeldris.md)** é a sua personalidade de combate/agressiva, com traços Illithid (fria, calculista, curiosa pela mente).
* **O Crash:** O *crash* foi intencional (ou negligente), com o objetivo de causar o máximo de caos em Greyhawk e desviar a atenção do ataque Paladino à Taberna (S13). Os Illithids têm uma agenda que visa desestabilizar o equilíbrio de poder.

### 🤫 Secrets & Hooks / Segredos e Ganchos
* **O Anel de Zorg:** O **Anel de Chamado** não é apenas para chamar a comitiva; é um dispositivo de rastreamento Illithid. Ao usá-lo, **[Sarvian Midlor](pc_sarvian_midlor.md)** ligou-se mais profundamente à rede Illithid.
* **O Baile de Zorg:** O interesse de **[Zorg](zorg.md)** no Baile de [Blackfair Manor](blackfair_manor.md) confirma que o Culto do Mal Elemental (CME) e os Illithids estão a convergir para o mesmo local. O CME quer a tecnologia da nave, e os Illithids querem os participantes do Baile.
* **Mortes Massivas:** As mortes no bairro de luxo devem criar um gancho de **consequências legais/sociais** para o grupo, forçando-os a esconder os seus laços com os Illithids e o Taberneiro.

### ⚙️ Contingencies / Contingências
* **Resgate de Endouvan:** O resgate de **[Endouvan Bom Sossego](pc_endouven_bomsossego.md)** estabeleceu a sua lealdade inabalável à *party* (apesar da sua natureza Hobgoblin).
* **Recompensa:** O grupo não recebeu a recompensa de 25 GP da missão original (S08), reforçando que a Companhia não recompensa o caos (mesmo que justificado).
...
| Ficheiro | Tipo |
| :--- | :--- |
| [Sessão DnD 27-03.docx](uploaded:Sessão%20DnD%2027-03.docx) | Resumo de Sessão (Eventos) |
| [sessão 20 março.pdf](uploaded:Sessão%2020%20de%20março.pdf) | Notas do DM (Morte de Varus) |
...
| :--- | :--- | :--- |
| **Anel de Chamado** | Anel de tecnologia Illithid (para [Sarvian Midlor](pc_sarvian_midlor.md)). | Illithid technology Ring (for [Sarvian Midlor](pc_sarvian_midlor.md)). |
| **Ouro** | 10 GP (obtidos dos Illithids derrotados). | 10 GP (obtained from defeated Illithids). |

---

## 📊 Passo 3 — Index Maintenance / Manutenção do Índice

Com a conclusão da sessão **S13A: O Retorno da Nave Illithid**, os seguintes índices teóricos seriam atualizados com a referência ao ficheiro **(s13a_retorno_nave_illithid.md)**:
...
| **Monsters** | [Illithids / Mind Flayers](illithids.md) | S13A |
