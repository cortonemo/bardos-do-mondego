...
| Descrição | PT | EN |
| :--- | :--- | :--- |
| **Missão Principal** | O grupo é alertado para uma doença misteriosa que assola a pequena vila de **[Two Fords](docs/locations/-/regions/two_fords.md)**, causada pela contaminação da água. A investigação leva-os a um **[Moinho Abandonado](abandoned_mill.md)** onde o **[Culto do Mal Elemental](cult_of_elemental_evil.md)** estava a realizar um ritual para espalhar esporos fúngicos no **[Rio Ery](ery_river.md)**. | The party is alerted to a mysterious illness plaguing the small village of **[Two Fords](docs/locations/-/regions/two_fords.md)**, caused by water contamination. The investigation leads them to an **[Abandoned Mill](abandoned_mill.md)** where the **[Cult of Elemental Evil](cult_of_elemental_evil.md)** was performing a ritual to spread fungal spores in the **[Ery River](ery_river.md)**. |
...
| Evento | PT | EN |
| :--- | :--- | :--- |
| **A Notícia em Two Fords** | O grupo conhece o **[Wandering Sage](pc_wandering_sage.md)** na Taberna e, ao seguir para a vila de **[Two Fords](docs/locations/-/regions/two_fords.md)**, encontra o mercador **[Kaldros Veynor](docs/npc/-/Peculiar%20Manor/npc_kaldros_veynor.md)** que os alerta para a doença local. O taberneiro **[Gerald](gerald.md)** confirma que a sua filha **[Lila](lila.md)** está gravemente doente. | The party meets the **[Wandering Sage](pc_wandering_sage.md)** in the Tavern and, while heading to the village of **[Two Fords](docs/locations/-/regions/two_fords.md)**, meets the merchant **[Kaldros Veynor](docs/npc/-/Peculiar%20Manor/npc_kaldros_veynor.md)** who alerts them to the local illness. The barkeep **[Gerald](gerald.md)** confirms that his daughter **[Lila](lila.md)** is gravely ill. |
...
| **Fuga e o Pergaminho** | O Acólito consegue escapar, mas o grupo recupera um pergaminho com anotações que detalham o plano do **[Culto do Mal Elemental](cult_of_elemental_evil.md)** para enfraquecer a região de forma coordenada. | The Acolyte manages to escape, but the party recovers a scroll with annotations detailing the **[Cult of Elemental Evil](cult_of_elemental_evil.md)'s** plan to weaken the region in a coordinated manner. |
...
| **[Kaldros Veynor](docs/npc/-/Peculiar%20Manor/npc_kaldros_veynor.md)** | Mercador que informa o grupo sobre a doença em Two Fords. | Merchant who informs the party about the illness in Two Fords. |
...
| Gancho | PT | EN |
| :--- | :--- | :--- |
| **O Acólito em Fuga** | O líder da célula do culto fugiu e é um agente ativo que reportará o falhanço ao seu superior, tornando o grupo num alvo conhecido do **[Culto do Mal Elemental](cult_of_elemental_evil.md)**. | The leader of the cult cell escaped and is an active agent who will report the failure to their superior, making the party a known target of the **[Cult of Elemental Evil](cult_of_elemental_evil.md)**. |
...
| **O Apelo de Gerald** | O Taberneiro **[Gerald](gerald.md)**, aliviado pela interrupção do ritual, pode oferecer a **[Two Fords](docs/locations/-/regions/two_fords.md)** como um *safe haven* futuro, ou um ponto de contacto importante para informações sobre o comércio e viagens. | The Barkeep **[Gerald](gerald.md)**, relieved by the ritual's interruption, may offer **[Two Fords](docs/locations/-/regions/two_fords.md)** as a future *safe haven*, or an important contact point for trade and travel information. |
...
* **Se o grupo falhasse:** A contaminação do **[Rio Ery](ery_river.md)** teria atingido o pico, transformando **[Two Fords](docs/locations/-/regions/two_fords.md)** numa zona de quarentena e potencialmente criando uma ameaça *undead* local, forçando o grupo a lidar com um problema mais grave (e de nível superior) no futuro.
