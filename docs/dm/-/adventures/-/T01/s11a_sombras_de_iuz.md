...
| Descrição | PT | EN |
| :--- | :--- | :--- |
| **Missão Principal** | O grupo é convocado para uma missão genérica, mas a receção de uma carta de chantagem endereçada a **[Kai](docs/pc/-/pc_kai_vanthir.md)** (expondo o seu segredo como impostor) desencadeia um encontro urgente. O alvo da chantagem, o drow **[Raveth Xil-Zyrl](docs/npc/-/unknown/npc_raveth_xil_zyrl.md)**, propõe uma aliança nas **Ruínas Vanthir**. | The party is summoned for a generic mission, but the reception of a blackmail letter addressed to **[Kai](docs/pc/-/pc_kai_vanthir.md)** (exposing his secret as an impostor) triggers an urgent meeting. The blackmailer, the drow **[Raveth Xil-Zyrl](docs/npc/-/unknown/npc_raveth_xil_zyrl.md)**, proposes an alliance at the **Vanthir Ruins**. |
...
| Evento                            | PT                                                                                                                                                                                                                                                                                                                                                           | EN                                                                                                                                                                                                                                                                                                                                             |
| :-------------------------------- | :----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | :--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **A Carta de Chantagem e o Lobo** | **[Kai](docs/pc/-/pc_kai_vanthir.md)** recebe uma carta misteriosa de um drow. A carta expõe que Kai é um impostor, vivendo sob o nome de um herdeiro de Iuz, e exige um encontro nas ruínas da [Casa Vanthir](vanthir_ruins.md) para negociar o silêncio.                                                                                                                     | **[Kai](docs/pc/-/pc_kai_vanthir.md)** receives a mysterious letter from a drow. The letter exposes Kai as an impostor, living under the name of an heir of Iuz, and demands a meeting at the [Vanthir Ruins](vanthir_ruins.md) to negotiate his silence.                                                                                                        |
...
| **O Encontro com Raveth**         | O grupo encontra o drow **[Raveth Xil-Zyrl](docs/npc/-/unknown/npc_raveth_xil_zyrl.md)**, que se apresenta como um agente de [Iuz](iuz.md) e se dirige a **[Triss Merril](docs/dm/-/pc/pc_triss_merril.md)** com a sugestão de que existem outros Drows como ela em Greyhawk. Raveth procura usar Kai para restaurar a [Casa Vanthir](vanthir_ruins.md) para os seus próprios fins. | The party meets the drow **[Raveth Xil-Zyrl](docs/npc/-/unknown/npc_raveth_xil_zyrl.md)**, who presents himself as an agent of [Iuz](iuz.md) and addresses **[Triss Merril](docs/dm/-/pc/pc_triss_merril.md)**, suggesting there are other Drows like her in Greyhawk. Raveth seeks to use Kai to restore the [Vanthir House](vanthir_ruins.md) for his own purposes. |
| **Chegada dos Paladinos**         | **[Paladinos de Beltar](paladins_of_beltar.md)**, (liderados por [Bareth LionMane](npc_bareth_lionmane.md)) chegam ao local com Cães Demoníacos, com o objetivo de capturar Raveth.                                                                                                                                                                              | **[Paladins of Beltar](paladins_of_beltar.md)**, (led by [Bareth LionMane](npc_bareth_lionmane.md)) arrive with Demonic Dogs to capture Raveth.                                                                                                                                                                                                    |
| **A Captura de Dustin**           | **[Paladinos de Beltar](paladins_of_beltar.md)** reconhecem **[Dustin Thorne](pc_dustin_thorne.md)**, que havia sido dado como morto pela Ordem, e acusam-no de traição, levando-o acorrentado para o [Castelo Ruína-de-Ebano](ebony_ruin_castle.md).                                                                                                        | **[Paladinos de Beltar](paladins_of_beltar.md) **recognize **[Dustin Thorne](pc_dustin_thorne.md)**, who had been presumed dead by the Order, and accuse him of treason, taking him in chains to [Ebony-Ruin Castle](ebony_ruin_castle.md).                                                                                                    |
...
| Personagem                                          | PT                                                                                                      | EN                                                                                                           |
| :-------------------------------------------------- | :------------------------------------------------------------------------------------------------------ | :----------------------------------------------------------------------------------------------------------- |
| **[Kai](docs/pc/-/pc_kai_vanthir.md)**                                | O alvo da chantagem, o seu segredo é exposto por Raveth. Tenta negociar para proteger a sua identidade. | The target of the blackmail, his secret is exposed by Raveth. He tries to negotiate to protect his identity. |
...
| **[Raveth Xil-Zyrl](docs/npc/-/unknown/npc_raveth_xil_zyrl.md)**           | Drow chantagista, agente de Iuz, que escapa no meio do caos, deixando um artefato.                      | Blackmailing drow, agent of Iuz, who escapes in the chaos, leaving behind an artifact.                       |
| **[Bareth LionMane](npc_bareth_lionmane.md)**           | Líder dos Paladinos de Beltar que captura Dustin.                                                       | Leader of the Paladins of Beltar who captures Dustin.                                                        |
...
| **O Segredo de Kai** | O segredo de **[Kai](docs/pc/-/pc_kai_vanthir.md)** é conhecido por [Raveth Xil-Zyrl](docs/npc/-/unknown/npc_raveth_xil_zyrl.md), tornando o drow um inimigo ou um aliado volátil e imprevisível. O segredo pode ser usado para chantagem futura. | **[Kai](docs/pc/-/pc_kai_vanthir.md)'s** secret is known by [Raveth Xil-Zyrl](docs/npc/-/unknown/npc_raveth_xil_zyrl.md), making the drow an unpredictable enemy or a volatile ally. The secret can be used for future blackmail. |
...
* **Finalidade de Raveth:** Raveth não está *apenas* a chantagear [Kai](docs/pc/-/pc_kai_vanthir.md); ele quer um fantoche no poder da [Casa Vanthir](vanthir_ruins.md) para usá-la como um veículo de influência de [Iuz](iuz.md) na superfície.
...
* **Se Raveth fosse capturado:** Ele tentaria convencer os Paladinos que estava a tentar capturar **[Kai](docs/pc/-/pc_kai_vanthir.md)** para eles. Se falhasse, usaria a sua *net* de informantes para negociar a sua libertação em troca de informações sobre o Culto do Mal Elemental (que os Paladinos desprezam, mas não ignoram).
