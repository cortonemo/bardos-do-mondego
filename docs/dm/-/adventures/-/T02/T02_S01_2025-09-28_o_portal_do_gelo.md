...
| Português | English |
|------------|----------|
| **Chamado da Fada Val** — Na [Taberna](taverna.md), os aventureiros recebem o apelo mágico da [Fada Val](npc_fada_val.md). Ela revela que o [Doutor Galileu](npc_doutor_galileu.md) precisa de ajuda para abrir um portal. | **Call of Fada Val** — At the [Tavern](taverna.md), the adventurers receive the magical summons from [Fada Val](npc_fada_val.md). She reveals that [Doctor Galileu](npc_doutor_galileu.md) needs help opening a portal. |
...
| **Conclusão** — O [Doutor Galileu](npc_doutor_galileu.md) recompensa os heróis e a [Fada Val](npc_fada_val.md) promete restaurar a [Taberna](taverna.md). | **Conclusion** — [Doctor Galileu](npc_doutor_galileu.md) rewards the heroes and [Fada Val](npc_fada_val.md) promises to restore the [Tavern](taverna.md). |
...
| Item | Detalhes |
|------|-----------|
| [Red Diamond](red_diamond.md) | Entregue ao [Doctor Galileu](npc_doutor_galileu.md) como núcleo de energia. |
...
| 250 gp | Recompensa paga a cada membro pelo [Doctor Galileu](npc_doutor_galileu.md). |
...
| Português                                                                                                                                                                                                                                                                                                                                              | English                                                                                                                                                                                                                                                                                                                                              |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| As runas nos pilares contêm símbolos idênticos aos usados pelo [Institute of the Veiled Light](institute_of_the_veiled_light.md), implicando que o [Doctor Galileu](npc_doutor_galileu.md) pode ter sido uma criação do Instituto. O [Magic Compass](magic_compass.md) reage a energias de portais semelhantes, servindo como gancho para futuras missões. | The runes on the pillars bear symbols identical to those used by the [Institute of the Veiled Light](institute_of_the_veiled_light.md), implying that [Doctor Galileu](npc_doutor_galileu.md) may have been a creation of the Institute. The [Magic Compass](magic_compass.md) reacts to similar portal energies, serving as a hook for future missions. |
