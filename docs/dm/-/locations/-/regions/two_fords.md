...
| **[Kaldros Veynor](kaldros_veynor.md)** (NPC)                                                                                                                                                                                                       | Mercador que o grupo encontrou enquanto viajavam para Two Fords, alertando-os para a doença local. Foi resgatado anteriormente noutra missão.        | Merchant the party met while travelling toward Two Fords, alerting them to the local illness. He was previously rescued on another mission.             |
