...
| Situada numa **rota de comércio crucial**, ligando [Greyhawk](free_city_of_greyhawk.md) a [Erybend](erybend.md). | Located on a **crucial trade route**, linking [Greyhawk](free_city_of_greyhawk.md) to [Erybend](erybend.md). |
...
| **S05B: O Resgate** | Caravanas que viajavam entre Two Fords e [Erybend](erybend.md) foram alvo de sequestro por **cultistas de [Nerull](docs/dm/-/organizations/-/cults/cult_of_nerull.md)**, que usavam as vítimas em rituais. | Caravans traveling between Two Fords and [Erybend](erybend.md) were targeted by kidnapping by **cultists of [Nerull](docs/dm/-/organizations/-/cults/cult_of_nerull.md)**, who used the victims in rituals. |
| **Ameaça Goblin/Nerull** | Um relatório interno do Culto de [Nerull](docs/dm/-/organizations/-/cults/cult_of_nerull.md) indica que os **goblins** estavam prontos para iniciar preparativos nas terras próximas a Two Fords, aguardando ordens para desestabilizar a região. | An internal [Nerull](docs/dm/-/organizations/-/cults/cult_of_nerull.md) Cult report indicated that **goblins** were ready to start preparations in the lands nearby Two Fords, awaiting orders to destabilize the region. |
...
| :-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | :--------------------------------------------------------------------------------------------------------------------------------------------------- | :------------------------------------------------------------------------------------------------------------------------------------------------------ |
| **Gerald** (NPC)                                                                                                                                                                                                                                    | O **taberneiro** local que procurou ajuda e serviu como catalisador da missão (S04A) devido à doença da sua filha, **[Lila](npc_lila.md)**.          | The local **barkeep** who sought help and served as the mission's catalyst (S04A) due to his daughter's illness, **[Lila](npc_lila.md)**.               |
| **[Lila](npc_lila.md)** (NPC)                                                                                                                                                                                                                       | Filha de Gerald, estava **gravemente doente** devido à água contaminada, sendo a principal motivação para a investigação (S04A).                     | Gerald’s daughter, who was **gravely ill** due to the contaminated water, serving as the primary motivator for the investigation (S04A).                |
| **[Kythria](docs/npc/-/Free%20City%20of%20Grehawk/npc_kythria.md)** (NPC)                                                                                                                                                                           | Sobrinha do Taberneiro; ela enviou missões de **reconhecimento comercial** para avaliar a segurança da rota entre Two Fords e [Erybend](erybend.md). | The Barkeep’s niece; she assigned **commercial reconnaissance** missions to assess the safety of the route between Two Fords and [Erybend](erybend.md). |
...
| :--- | :--- |
| Two Fords | free_city_of_greyhawk.md, eribend.md, nerull.md, lila.md, kythria.md, rix.md, pc_arkos_vasell.md, s03_ataque_rio_neem.md, s04a_culto_two_fords.md, pc_gauthak_vunakamune.md, s09a_sombras_sobre_a_agua.md, s10a_intriga_high_ery.md, s14b_dandan_e_os_40_kobolds.md, s15b_a_crianca_perdida.md, pc_orianna.md, pc_lone_straw.md, s05b_campo_goblin_nerull.md, pc_wandering_sage.md, s10b_resgate_rolger.md, s22a_golpe_dados_rubi_p1.md, s23a_golpe_dados_rubi_p2.md, s30b_idolo_lady_scale_p2.md, pc_endouven_bomsossego.md, s13b_retorno_nave_illithid.md, kaldros_veynor.md |

#### Warnings

| Type | Where | Detail |
| :--- | :--- | :--- |
| Missing Session | Table `🎭 Pessoal Chave (NPCs & PCs) / 🎭 Key Personnel (NPCs & PCs)` (Row 5) | Session S04A is present in the table but file `s04a_culto_two_fords.md.md` has an extra extension in `Recapitulativo Temporada 01.md`. Using `s04a_culto_two_fords.md.md` in link, but linking to the existing `s04a_culto_two_fords.md` file. |

#### Missing Files

| Type | Where | Detail |
| :--- | :--- | :--- |
| NPC Name | Table `🎭 Pessoal Chave (NPCs & PCs) / 🎭 Key Personnel (NPCs & PCs)` (Row 2) | Missing file: lila.md |
| NPC Name | Table `🎭 Pessoal Chave (NPCs & PCs) / 🎭 Key Personnel (NPCs & PCs)` (Row 4) | Missing file: rix.md |